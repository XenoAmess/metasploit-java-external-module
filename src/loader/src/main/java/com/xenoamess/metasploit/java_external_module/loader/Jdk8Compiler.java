 ...
 */
/*
 * original code from https://github.com/apache/dubbo/blob/master/dubbo-common/src/main/java/org/apache/dubbo/common/compiler/support/JdkCompiler.java
 * modified source and target from 1.6 to 1.8.
 */
 ...
 */
public class Jdk8Compiler extends AbstractCompiler {
    ...
    private final class ClassLoaderImpl extends ClassLoader {
        ...
        protected Class<?> findClass(final String qualifiedClassName) throws ClassNotFoundException {
            ...
            try {
                return org.apache.dubbo.common.utils.ClassUtils.forNameWithCallerClassLoader(qualifiedClassName,
                        getClass());
